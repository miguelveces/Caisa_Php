...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $id_empresa =isset($_POST['id']) ? mysqli_real_escape_string($connect, $_POST['id']) :  "";
	$id_usuario= isset($_SESSION['id_usuario']) ? mysqli_real_escape_string($connect, $_SESSION['id_usuario']) :  "";




	$param = array('id_empresa' => $id_empresa,'id_usuario' => $id_usuario); 
	$result = $client->call('DeleteCompanyByid',$param,'','','',true);
