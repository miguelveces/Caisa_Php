...
{	
	...
	$resultRecordsTransactions = $client->call('GetEmployeesRecordsTransactionsByid',$param,'','','',true);
 ...
 $json = array("status" => 1, "info" => $result, "infotran" => $resultRecordsTransactions, "infoperiod" => $resultPeriod);
