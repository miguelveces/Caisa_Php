...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2016 a las 23:27:45
...
--
-- Estructura de tabla para la tabla `comprobantes_empleados`
--

CREATE TABLE IF NOT EXISTS `comprobantes_empleados` (
  `id_comprobante_empleado` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `total_ingreso` varchar(100) DEFAULT NULL,
  `total_descuento` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_comprobante_empleado`)
...
(13, 134, '00022', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(14, 135, '00044', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(15, 136, '00024', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(16, 137, '00007', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(17, 138, '00019', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(18, 139, '00002', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(19, 140, '00011', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(20, 141, '00048', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(21, 142, '00040', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(22, 143, '00023', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(23, 144, '00018', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1),
(24, 145, '00049', '0000000000000', 4, 'CUENTAS AHORROS', 'ACH', 1);
...
(1, 'AHO-NA', 'AHORRO DE NAVIDAD EMPLEADOS', 'DESCUENTO', '', '2015-10-30 15:54:14', 2),
(2, 'BANGEN', 'BANCO GENERAL, S.A.', 'DESCUENTO', '', '2015-10-30 15:55:10', 2),
(3, 'COPER6', 'PRESTAMOS DE COOPERATIVA', 'DESCUENTO', '', '2015-10-30 15:56:15', 2),
(4, 'COPERA', 'COOPERATIVA DE AHORRO DE EMPLEADOS CAISA', 'DESCUENTO', '', '2015-10-30 15:57:06', 2),
(5, 'RIAJO', 'C X P RIAJO', 'DESCUENTO', '', '2015-10-30 15:58:07', 2);
...
INSERT INTO `descuentos_ingresos_empleados` (`id_descuento_ingreso_empleado`, `numero_cliente`, `numero_cuenta`, `id_empleado`, `numero_empleado`, `id_descuento_ingreso`, `monto_mes`, `monto_periodo`, `afecta_diciembre`, `prioridad`, `tipo`, `frecuencia`, `monto_urgente`, `monto_original`, `monto_pendiente`, `estado`, `referencia`, `id_periodo`, `fecha_ultimo_pago`, `cantidad_pago`, `fecha_creacion`, `id_usuario`) VALUES
(1, '', '', 13, '00004', 1, '14.00', '7.00', 'NO', '4', '3', '', '', '200.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(2, '', '', 13, '00004', 4, '10.00', '5.00', 'NO', '4', '3', '', '', '200.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(3, '', '', 16, '00007', 4, '10.00', '5.00', 'NO', '4', '3', '', '', '300.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(4, '', '', 17, '00006', 1, '48.00', '24.00', 'NO', '4', '3', '', '', '200.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(5, '', '', 17, '00006', 4, '10.00', '5.00', 'NO', '4', '3', '', '', '250.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(6, '', '', 18, '00002', 1, '24.00', '12.00', 'NO', '4', '3', '', '', '200.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(7, '', '', 18, '00002', 2, '67.06', '33.53', 'NO', '4', '3', '', '', '500.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(8, '', '', 18, '00002', 3, '40.00', '20.00', 'NO', '4', '3', '', '', '200.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(9, '', '', 18, '00002', 4, '10.00', '5.00', 'NO', '4', '3', '', '', '100.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2),
(10, '', '', 18, '00002', 5, '30.00', '15.00', 'NO', '4', '3', '', '', '300.00', '', 1, '', 3, '2015-11-04', 0, '2015-11-04 16:32:36', 2);
...
CREATE TABLE IF NOT EXISTS `descuentos_ingresos_empleados_detalles` (
  ...
  `pendiente1` varchar(100) DEFAULT NULL,
  `pendiente2` varchar(100) DEFAULT NULL,
  `pendiente3` varchar(100) DEFAULT NULL,
  `pendiente4` varchar(100) DEFAULT NULL,
  `pendiente5` varchar(100) DEFAULT NULL,
  `pendiente6` varchar(100) DEFAULT NULL,
  `estado` int(11) DEFAULT NULL,
  `id_periodo` int(11) DEFAULT NULL,
  `id_empresa` int(11) DEFAULT NULL,
  `fecha_creacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(1, '2015-05-01', 'Dia del tarbajo', '2015-10-10 13:52:46', 2),
(2, '2014-02-03', 'prueba', '2015-10-10 13:58:00', 2);
...
(13, '00004', 'ROSA EVELIA', 'MARTINEZ', '9-125-1252', '1961-05-11', '15-0559', '', 1, 2, 1, 1, 0, '0000-00-00', 'A-0', '', '297.44', '1.43', '208', '2009-01-02', '0000-00-00', '0000-00-00', 1, '', 0, '0000-00-00', 2, 10, 6),
(16, '00007', 'BASILIDES', 'RODRIGUEZ', '2-102-2071', '1965-06-30', '2-102-2071', '', 1, 1, 1, 1, 0, '0000-00-00', 'E-3', '', '297.44', '1.43', '208', '2011-03-16', '0000-00-00', '0000-00-00', 0, '', 0, '0000-00-00', 2, 10, 6),
(17, '00006', 'CATALINO', 'RODRIGUEZ MAGALLON', '9999-999', '1978-11-25', '9999-999', '', 1, 1, 1, 1, 0, '0000-00-00', 'A-0', '', '297.44', '1.43', '208', '2010-01-02', '0000-00-00', '0000-00-00', 0, '', 0, '0000-00-00', 2, 10, 6),
(18, '00002', 'DIDIMO IVAN', 'VALDEZ', '9999-999', '1973-05-28', '9999-999', '', 1, 1, 1, 1, 0, '0000-00-00', 'A-0', '', '339.04', '1.63', '208', '2007-09-01', '0000-00-00', '0000-00-00', 0, '', 0, '0000-00-00', 2, 10, 6),
...
(1, 228, '00002', '2014-01-26', 'Sunday', 0, 'L', 'D', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(2, 228, '00002', '2014-01-27', 'Monday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(3, 228, '00002', '2014-01-28', 'Tuesday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(4, 228, '00002', '2014-01-29', 'Wednesday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(5, 228, '00002', '2014-01-30', 'Thursday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(6, 228, '00002', '2014-01-31', 'Friday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(7, 228, '00002', '2014-02-01', 'Saturday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(8, 228, '00002', '2014-02-02', 'Sunday', 0, 'L', 'D', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(9, 228, '00002', '2014-02-03', 'Monday', 0, 'L', 'F', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(10, 228, '00002', '2014-02-04', 'Tuesday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(11, 228, '00002', '2014-02-05', 'Wednesday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(12, 228, '00002', '2014-02-06', 'Thursday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(13, 228, '00002', '2014-02-07', 'Friday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(14, 228, '00002', '2014-02-08', 'Saturday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(15, 228, '00002', '2014-02-09', 'Sunday', 0, 'L', 'D', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014'),
(16, 228, '00002', '2014-02-10', 'Monday', 1, '', 'R', 'N', '01', '', '07:00 AM', '04:00 PM', '8.50', '0.00', 3, '2014');
