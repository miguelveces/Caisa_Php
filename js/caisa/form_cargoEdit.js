		    ...
		    $.ajax({
				...
				success: function(data) {
				 //alert(data.info[0].id_fk_rol);
						...
						if (data.status == 1)
						{
							$('#txtCodPosition').val(data.info[0].codigo_cargo);
							$('#txtNamePosition').val(data.info[0].nombre_cargo);
                ...
                success: function(data) {
				   ...
				   //alert(id);
					if(data.status == 1)
					{
							...
							$('#success > .alert-success').append("<strong>El Cargo  fue Modificado correctamente</strong>");
					...
					else
					{
							...
							$('#success > .alert-danger').append("NO se Modifico el Cargo");
